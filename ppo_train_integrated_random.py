...
python3 ppo_train_integrated_random.py \
  ...
  --rollout-steps 2048 --batch-size 256 --lr 2e-4 --device cpu
"""
...
def parse_args():
    ...
    p.add_argument("--pretrained-main", default="checkpoints_integrated/main_iter150.pt")
    p.add_argument("--pretrained-escape", default="checkpoints_integrated/escape_iter150.pt")
    # 콜랩 드라이브 연동
