...
def main():
    ...
    parser.add_argument("--ckpt", default="checkpoints_integrated_random/ppo_dyn_iter3000.pt")
    parser.add_argument("--escape-ckpt", default="checkpoints_integrated_random/escape_best(3150).pt", help="ESC 서브 정책 checkpoint")
    parser.add_argument("--grid-path", default="map_grid.npy")
    parser.add_argument("--waypoints-path", default="waypoints.npy")
    parser.add_argument("--seed", type=int, default=3472)
