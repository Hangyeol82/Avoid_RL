...
def main():
    ...
    parser.add_argument("--escape-ckpt", default="checkpoints_integrated_random/escape_iter800.pt", help="ESC 서브 정책 checkpoint")
    parser.add_argument("--grid-path", default="map_grid.npy")
    parser.add_argument("--waypoints-path", default="waypoints.npy")
    parser.add_argument("--seed", type=int, default=8792)
